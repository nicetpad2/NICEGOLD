...
class TestModernScalping(unittest.TestCase):
    ...
    def test_compute_features_columns(self):
        ...
        res = nicegold.modern_compute_features(df)
    ...
    def test_train_signal_model(self):
        ...
        df = nicegold.modern_compute_features(df)
        res = nicegold.modern_train_signal_model(df)
    ...
    def test_run_backtest_returns_dataframe(self):
        ...
        df = nicegold.modern_compute_features(df)
        df = nicegold.modern_train_signal_model(df)
        trades = nicegold.modern_run_backtest(df)
